...
<html lang="en">
<head>
<title> Muli Jedy Hotels -Rooms </title>
    <meta charset="UTF-8">
...
<div class="container">
 ...
 <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 px-lg-0">
  ...
  <div class="container-fluid flex-lg-column align-items-stretch">
    ...
    <div class="collapse navbar-collapse flex-column align-items-stretch mb-2" id="filterDropdown">
        ...
        <div class="card mb-4 border-0 shadow">
            <div class="row g-0 p-3 align-items-center">
                <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                    <img src="Images/rooms1.jpeg" class="img-fluid rounded-start">
                </div>
